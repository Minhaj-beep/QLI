...
import { View, Text, HStack, VStack, Icon, useToast, Image, ScrollView, Button, Modal, IconButton, Heading, FormControl, Input, Select } from "native-base"
  ...
  return (
    <SafeAreaView>
      ...
      <VStack style={styles.Container}>
       {allData && <RenderTransactionHistory/> }     
       {/* {THistory && <RenderTH/> }      */}
      </VStack>
      </ScrollView>
    </SafeAreaView>
